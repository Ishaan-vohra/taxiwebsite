...
const groupedEvents = {
  "Saturday 8/31": [
    ...
    },
    {
      ...
      type: "Casual",
      description:
        "Come chill and play our favorite games with us: chess, pool, avalon, poker, foosball, and much more!",
      host: "Theta Xi",
      location: "64 Bay State Road, Boston",
      group: "Theta Xi",
    },
  ...
  "Sunday 9/1": [
    {
      name: "Hei La Moon Dim Sum",
      start_time: "11:00 AM",
      end_time: "2:00 PM",
      type: "Lunch",
      description: "Join us for lunch at Hei La Moon dimsum!",
      host: "Hei La Moon",
      location: "83 Essex St, Boston",
      group: "Theta Xi",
    },
    {
      name: "Rock Climbing",
      ...
      type: "Jaunt",
      description:
        "Come join us for an afternoon of adventurous rock climbing at Rockspot South Boston. Learn how to scale professional rock walls, then test your skills and experience the thrill of scaling indoor walls up to 45 feet high. All skill levels welcome, no previous rock-climbing experience necessary.",
      host: "Rockspot",
      location: "30 Old Colony Ave, Boston",
      group: "Theta Xi",
    },
    {
  ...
  "Monday 9/2 (Labor Day)": [
    ...
    {
      name: "Axe Throwing + Raising Canes",
      start_time: "4:00 PM",
      end_time: "8:00 PM",
      type: "Jaunt",
      description:
        "Enjoy some fried chicken and Texas toast from Raising Cane's, and show us your axe throwing skills at Axe Throwing Club Boston!",
      host: "Axe Throwing Club Boston",
      location: "42 Cross St, Boston, MA",
      group: "Theta Xi",
    },
    {
      name: "B.A.S.H.",
